...
from roictrl.pipelines.pipeline_stable_diffusion import StableDiffusionPipeline
...
if __name__ == "__main__":
    ...
    result.save('results/paper_results/application/different_model/RealisticV4_object_baseline.png')

    result_box = draw_box(result, input_data['roi_boxes'], input_data['roi_phrases'], height=input_data['height'], width=input_data['width'])
    result_box.save("results/paper_results/application/different_model/RealisticV4_object_baseline_box.png")